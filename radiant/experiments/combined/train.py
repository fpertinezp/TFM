...
def train_agent(seed):
    ...
    train_env = MultiObsWrapper(train_env, n=4, flatten=True)
    train_env = WeatherForecastingWrapper(train_env, n=3, delta=2, weather_variability=[1.0, 0.0, 0.001])
    ...
    eval_env = MultiObsWrapper(eval_env, n=4, flatten=True)
    eval_env = WeatherForecastingWrapper(eval_env, n=3, delta=2, weather_variability=[1.0, 0.0, 0.001])
